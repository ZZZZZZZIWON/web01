...
public class HomeController {
	...
	public String home(Locale locale, Model model, Map<String, String> map, ModelMap modelmap) {
...
//		mod.addAttribute("mv",vo);
	...
	@RequestMapping("/cal")
	@ResponseBody
	public HashMap<String,Object> name(double x, double y) {
		System.out.println("ajaxddddd 테스트");
